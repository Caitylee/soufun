...
<html>
	...
	<body>
		<div id="header" class="wrap">
			...
			<div id="headbar">
				<#if userId!=null>
					<a href="toUserInfo">${userRealname}</a>&nbsp;&nbsp;
					<a href="toPub">发布房源</a>&nbsp;&nbsp;
					<a href="Logout">注销</a>
					<#else>
		...
		<div class="main wrap">
            ...
            <div id="pageTool">
				...
				<#if currentPage gt 1>
                    ...
                    <li><a href="home?page=${currentPage - 1}">${currentPage - 1}</a></li>
				<#else>
                    <li class="disabled"><a href="home?page=${currentPage-1}">上一页</a></li>
				</#if>
                    <li class="active"><a href="home?page=${currentPage}">${currentPage}</a></li>
				<#if currentPage lt totalPage>
                    <li><a href="home?page=${currentPage +1}">${currentPage +1}</a></li>
                    <li><a href="home?page=${currentPage + 1}">下一页</a></li>
				<#else>
                    <li class="disabled"><a href="home?page=${currentPage + 1}">下一页</a></li>
				</#if>
